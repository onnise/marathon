...
const TRANSLATIONS = {
  ...
  ar: {
    ...
    'about.body2':  'ينطلق السباق ويصل إلى ساحة بكفيا، ويمرّ بشوارع هذه المدينة الجبلية الرائعة، بينما يشجّع المتفرجون كل خطوة.',
    ...
    'sched.subtitle': 'جميع الفعاليات تنطلق وتنتهي في ساحة بكفيا. المواعيد تقريبية.',
    'sched.t1':  '7:00 ص',
    'sched.h1':  'التجمّع',
    'sched.p1':  'الحضور إلى ساحة بكفيا (خط الانطلاق بالقرب من محلّ ألفا)، استلام حقيبة السباق، الإحماء والاستعداد.',
    'sched.t2':  '8:00 ص',
    ...
    'sched.p3':  'مفتوح للجميع — جميع الأعمار، العائلات والمبتدئين.',
    'sched.t4':  '10:00 ص',
    ...
    'cta.body':  '20 سبتمبر 2026 — ساحة بكفيا. سجّل قبل 15 سبتمبر.',
    'cta.btn':   'احجز مكانك',
